...
import static org.zetool.math.Combinatorics.factln;
...
public class CombinatoricsTest {
    ...
    public void factorialNegativeFails() {
    ...
    @Test
    public void binomialCoefficientStandard() {
        ...
        for (int i = 0; i < nChoose2k.length; ++i) {
            int n = 2 * (i + 1);
            int k = i+1;
            assertThat(bico(n, k), is(equalTo(nChoose2k[i])));
            assertThat(bico(n, n - k), is(equalTo(nChoose2k[i])));
        }
    }
